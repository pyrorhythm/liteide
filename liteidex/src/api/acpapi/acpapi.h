...
**
** Copyright (c) 2026 LiteIDE. All rights reserved.
**
...
** are allowed to remain closed sourced and can be distributed under any
*license.
** These rights are included in the file LGPL_EXCEPTION.txt in this package.
**
**************************************************************************/
// Module: acpapi.h
// ACP (Agent Client Protocol) API - standard protocol for IDE-agent
// communication
// Author: Alexey P. | me@pyrorhythm.dev
...
public:
  ...
  virtual void
  connectToAgent(const QString &agentPath,
                 ACPTransportType type = ACPTransportType::Stdio) = 0;
  ...
  [[nodiscard]] virtual QList<ACPSessionInfo> listSessions() const = 0;

  // Prompting
  virtual void
  sendPrompt(const QString &sessionId, const QString &prompt,
             const ACPPromptOptions &opts = ACPPromptOptions()) = 0;
  virtual void cancelPrompt(const QString &sessionId) = 0;

  // Updates
  virtual void sendUpdate(const QString &sessionId, const QString &method,
...
public:
  ...
  [[nodiscard]] virtual QStringList supportedAgents() const = 0;
};
