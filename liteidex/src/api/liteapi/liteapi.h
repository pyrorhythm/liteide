...
public:
  ...
  virtual IApplication *application() { return m_liteApp; }
...
public:
  ...
  [[nodiscard]] virtual QList<IMimeType *> mimeTypeList() const = 0;
  [[nodiscard]] virtual IMimeType *findMimeType(const QString &type) const = 0;
  [[nodiscard]] virtual QString
  findPackageByMimeType(const QString &type) const = 0;
  [[nodiscard]] virtual QString
  findMimeTypeByFile(const QString &fileName) const = 0;
  [[nodiscard]] virtual QString
  findMimeTypeBySuffix(const QString &suffix) const = 0;
  [[nodiscard]] virtual QString
  findMimeTypeByScheme(const QString &scheme) const = 0;
  [[nodiscard]] virtual QStringList
  findAllFilesByMimeType(const QString &dir, const QString &type,
                         int deep = 0) const = 0;
};

inline QString mimeHead(const QString &mimeType) {
  auto find = mimeType.indexOf('/');
  if (find == -1) {
    return mimeType;
  }
...
public:
  ...
  virtual ~IFile() {}
  virtual bool loadText(const QString &filePath, const QString &mimeType,
                        QString &outText) = 0;
...
public:
  ...
  virtual bool findTargetInfo(const QString &fileName, const QString &mimetype,
                              QMap<QString, QString> &targetInfo) const = 0;
};
...
class ISettingRecent : public IRecent {
  Q_OBJECT
public:
  ISettingRecent(QSettings *setting, QObject *parent)
      : IRecent(parent), m_settings(setting) {}
...
public:
  ...
  virtual void execFileWizard(const QString &projPath, const QString &filePath,
                              const QString &gopath = QString()) = 0;
  virtual bool openFile(const QString &fileName) = 0;
  virtual IEditor *openEditor(const QString &fileName, bool bActive = true,
                              bool ignoreNavigationHistory = false) = 0;
  virtual IEditor *
  openEditorByFactory(const QString &fileName, const QString &factoryId,
                      bool bActive = true,
                      bool ignoreNavigationHistory = false) = 0;
  virtual IEditor *createEditor(const QString &contents,
                                const QString &_mimeType) = 0;
  virtual IEditor *createEditor(const QString &fileName) = 0;
  virtual IProject *openProject(const QString &fileName) = 0;
  virtual IProject *openProjectScheme(const QString &fileName,
                                      const QString &scheme) = 0;
  virtual bool
  findProjectTargetInfo(const QString &fileName,
                        QMap<QString, QString> &targetInfo) const = 0;
  ...
  virtual void emitAboutToShowFolderContextMenu(
      QMenu *menu, LiteApi::FILESYSTEM_CONTEXT_FLAG flag, const QFileInfo &info,
      const QString &context) = 0;
signals:
  void fileListChanged();
  void fileWizardFinished(const QString &type, const QString &scheme,
                          const QString &location);
  void aboutToShowFolderContextMenu(QMenu *menu,
                                    LiteApi::FILESYSTEM_CONTEXT_FLAG flag,
...
public:
  ...
  virtual void gotoLine(int blockNumber, int column, bool center = false,
                        int selection = 0) = 0;
  virtual void setFindOption(FindOption *opt) = 0;
  virtual int position(PositionOperation posOp = Current,
                       int at = -1) const = 0;
...
inline ITextEditor *getTextEditor(IEditor *editor) {
  if (editor && editor->extension()) {
    return findExtensionObject<ITextEditor *>(editor->extension(),
                                              "LiteApi.ITextEditor");
  }
  return 0;
}
...
inline QMenu *getMenu(IObject *obj, const QString &id) {
  if (obj && obj->extension()) {
    return findExtensionObject<QMenu *>(obj->extension(),
                                        QString("LiteApi.Menu.%1").arg(id));
  }
  return 0;
}
...
inline IEditContext *getEditContext(IObject *obj) {
  if (obj && obj->extension()) {
    return findExtensionObject<IEditContext *>(obj->extension(),
                                               "LiteApi.IEditContext");
  }
  return 0;
}

inline QMenu *getEditMenu(IObject *obj) { return getMenu(obj, "Edit"); }
...
inline QPlainTextEdit *getPlainTextEdit(IEditor *editor) {
  if (editor && editor->extension()) {
    return findExtensionObject<QPlainTextEdit *>(editor->extension(),
                                                 "LiteApi.QPlainTextEdit");
  }
  return 0;
}
...
inline QToolBar *getEditToolBar(IEditor *editor) {
  if (editor && editor->extension()) {
    return findExtensionObject<QToolBar *>(editor->extension(),
                                           "LiteApi.QToolBar.Edit");
  }
  return 0;
}
...
public:
  ...
  virtual IEditor *openEditorByFactory(const QString &fileName,
                                       const QString &mimeType,
                                       const QString &factoryId) = 0;
  ...
  virtual void setCurrentEditor(IEditor *editor,
                                bool ignoreNavigationHistory = false) = 0;
  virtual IEditor *findEditor(const QString &fileName,
  ...
  virtual void
  addNavigationHistory(IEditor *editor = 0,
                       const QByteArray &saveState = QByteArray()) = 0;
...
class IOption : public IView {
  Q_OBJECT
public:
  explicit IOption(QObject *parent = nullptr) : IView(parent) {}
...
class IOptionFactory : public QObject {
  Q_OBJECT
public:
  IOptionFactory(QObject *parent = nullptr) : QObject(parent) {}
...
public:
  ...
  virtual QAction *
  addToolWindow(Qt::DockWidgetArea area, QWidget *widget, const QString &id,
                const QString &title, bool split,
                QList<QAction *> widgetActions = QList<QAction *>(),
                QList<QWidget *> widgetList = QList<QWidget *>()) = 0;
  virtual void moveToolWindow(Qt::DockWidgetArea from, Qt::DockWidgetArea to,
                              QAction *action, bool split) = 0;
...
public:
  ...
  virtual QWidget *widget() = 0;
  virtual QDockWidget *
  addDock(QWidget *widget, const QString &title,
          Qt::DockWidgetArea ares = Qt::LeftDockWidgetArea,
          Qt::DockWidgetAreas alowedAreas = Qt::LeftDockWidgetArea |
                                            Qt::RightDockWidgetArea,
          QDockWidget::DockWidgetFeatures features =
              QDockWidget::DockWidgetClosable | QDockWidget::DockWidgetMovable |
              QDockWidget::DockWidgetFloatable |
              QDockWidget::DockWidgetVerticalTitleBar) = 0;
...
public:
  ...
  virtual void regAction(QAction *act, const QString &id, const QString &defks,
                         bool standard = false) = 0;
  virtual void regAction(QAction *act, const QString &id,
                         const QKeySequence::StandardKey &def) = 0;
  virtual QStringList actionKeys() const = 0;
  virtual ActionInfo *actionInfo(const QString &id) const = 0;
  virtual void setActionShortcuts(const QString &id,
                                  const QString &shortcuts) = 0;
};
...
public:
  ...
  virtual QMenu *insertMenu(const QString &id, const QString &title,
                            const QString &idBefore = QString()) = 0;
  virtual QMenu *loadMenu(const QString &id) = 0;
  virtual void removeMenu(QMenu *menu) = 0;
  virtual QList<QString> menuList() const = 0;
  virtual QToolBar *insertToolBar(const QString &id, const QString &title,
                                  const QString &before = QString()) = 0;
  virtual void insertToolBar(QToolBar *toolBar,
                             const QString &before = QString()) = 0;
  ...
  virtual void setViewMenuSeparator(const QString &sepid,
                                    bool group = false) = 0;
  virtual void insertViewMenuAction(QAction *act, const QString &sepid) = 0;
  virtual bool insertMenuActions(const QString &idMenu,
                                 const QString &idBeforeSep, bool newGroup,
                                 QList<QAction *> &actions) = 0;
  virtual IActionContext *getActionContext(QObject *obj,
                                           const QString &name) = 0;
  virtual QStringList actionKeys() const = 0;
  virtual ActionInfo *actionInfo(const QString &id) const = 0;
  virtual void setActionShourtcuts(const QString &id,
                                   const QString &shortcuts) = 0;
...
public slots:
  virtual void call(const QByteArray &id,
                    const QByteArray &args = QByteArray()) = 0;
};
...
public:
  ...
  virtual void appendLog(const QString &model, const QString &log,
                         bool error = false) = 0;
  virtual void sendBroadcast(const QString &module, const QString &id,
                             const QVariant &param = QVariant()) = 0;
signals:
  void loaded();
  void aboutToQuit();
  void key_escape();
...
public:
  ...
  void setDependList(const QStringList &dependList) {
...
public:
  ...
  virtual ~IPluginFactoryImpl() { delete m_info; }
  virtual QString id() const { return m_info->id(); }
  virtual PluginInfo *info() const { return m_info; }
  virtual QStringList dependPluginList() const { return m_info->dependList(); }
  virtual void setFilePath(const QString &path) { m_info->setFilePath(path); }
  virtual QString filePath() const { return m_info->filePath(); }

protected:
  PluginInfo *m_info;
};

template <typename T> class PluginFactoryT : public IPluginFactoryImpl {
public:
  virtual IPlugin *createPlugin() { return new T; }
};
...
inline IAppIdleTimer *GetAppIdleTimer(LiteApi::IApplication *app) {
  return static_cast<IAppIdleTimer *>(
      app->extension()->findObject("LiteApi.IAppIdleTimer"));
}

inline bool gotoLine(IApplication *app, const QString &fileName, int line,
                     int col, bool forceCenter, bool saveHistory) {
  if (saveHistory) {
...
inline IWebKitBrowser *getWebKitBrowser(LiteApi::IApplication *app) {
  return static_cast<IWebKitBrowser *>(
      app->extension()->findObject("LiteApp.IWebKitBrowser"));
}
...
inline QString findPackageByMimeType(LiteApi::IApplication *app,
                                     const QString mimeType) {
